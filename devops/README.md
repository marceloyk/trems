...
```
DEPLOY_ENV=prod
DEPLOY_HOST=trems-marceloyk.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    trems-marceloyk.tangrama.com.br:
      ansible_user: root
      host: trems-marceloyk
      hostname: trems-marceloyk.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/trems-marceloyk.tangrama.com.br.yml` to the remote server with:
